...
public void quitter(){
	...
	NomField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
			false, 1, 1));
	NomField.setText(this.model.getNom());	Label lblPrenom = new Label(this, SWT.NONE);
	...
	PrenomField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
			false, 1, 1));
	PrenomField.setText(this.model.getPrenom());	Label lblAdresse = new Label(this, SWT.NONE);
